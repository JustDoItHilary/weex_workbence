...
var apiURL = {
    ...
    // userlistUrl:'http://192.168.100.140:8080/test/test/zhyTest'
    newserialcontent:'http://v3.wufazhuce.com:8000/api/serialcontent/',
...
exports.getTestMess=function(){
    return '难以忘记初次见你~';
};
exports.getMess = function ( callback) {
    callback('婉灵');
};
...
exports.getUserList = function (index, callback) {
    getData(apiURL.userlistUrl, callback);
};
...
exports.getNewSerialContent=function(id,callback){
    getData(apiURL.newserialcontent+id,callback);
}
