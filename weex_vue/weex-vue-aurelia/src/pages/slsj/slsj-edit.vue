<template>
    <div append="node" class="bg">
        <scroller>
            <div v-for="(item,index) in slsjList" style="margin-top: 8px;background-color: #fff;">
...
//                self.userGuid='@@OTk5OTk5fEAxNTYyMTg1NjUzM3xAMTFhOGY0MDZiYzc5OWMwOTRjNzFiMmEwYjg5OWU4YWZ8QHYzLjIuMWMxNzA4Mjl8QDU4ZTMxMjdkZmI4NmUzNDM1ODgyZGRkNWU0MDQ5YWJi';
