<template>
    <div v-ratio="ratio"  class="root">
        <div ref="circle"
             v-ratio="ratio"
             :style="{ borderColor: circleColor,opacity:opa,height:circleSize,width:circleSize,borderRadius:circleSize,borderBottomWidth:circleWidth,borderLeftWidth:circleWidth}"
        ></div>
    </div>
</template>
