    ...
    <div>
        ...
        <div v-ratio="ratio"
            ...
            <div v-ratio="ratio"
                ...
                <text v-ratio="ratio"
                      class="text_def_iOS">工作台</text>
            </div>
            <text v-ratio="ratio"
                  class="text_def_iOS"
                  @click="clickRight">{{titRight}}</text>
        </div>
    </div>
</template>
<script>
