...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/51ba15bd4145fffc41be00f073f99e88', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/51ba15bd4145fffc41be00f073f99e88',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "style": {
	        "height": function () {return this.navpageHeight}
	      }
	    },
	    {
	      "type": "div",
	      ...
	      "style": {
	        "top": function () {return this.navpageHeight}
	      },
	      "children": [
	        {
	          "type": "text",
	          ...
	          "attr": {
	            "value": function () {return this.firTxt}
	          }
	        },
	        {
	          "type": "text",
	          ...
	          "attr": {
	            "value": function () {return this.secTxt}
	          }
	        }
	      ]
	    },
	    {
	      ...
	      "style": {
	        "top": function () {return this.titHeight}
	      },
	      "events": {
	        "pagestart": "pagestartEvt",
	        "pagefinish": "onpagefinishEvt",
	        "error": "errorEvt",
	        "appear": "appearEvt",
	        "pagechange": "onpagechangeEvt"
	      }
	    }
	  ]
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        pagestartEvt: function pagestartEvt(e) {
	            var self = this;
	            var txtStart = (0, _stringify2.default)(e);
	            console.log('pagestart', txtStart);
	            self.isClose = false;
	            self.isClose = true;
	        },

	        onpagefinishEvt: function onpagefinishEvt(e) {
	            var self = this;
	            var txtFinish = (0, _stringify2.default)(e);
	        ...
	        errorEvt: function errorEvt(e) {
	            var self = this;
	            var txtError = (0, _stringify2.default)(e);
	            console.log('error', txtError);
	        },

	        appearEvt: function appearEvt(e) {
	            var self = this;
	        }
	    },
